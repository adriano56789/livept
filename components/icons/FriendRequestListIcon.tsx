...
export const FriendRequestListIcon: React.FC<React.SVGProps<SVGSVGElement> & { active?: boolean }> = ({ active, ...props }) => (
  <svg fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke={active ? '#3B82F6' : '#6b7280'} {...props}>
