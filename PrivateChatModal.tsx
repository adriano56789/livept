...
const PrivateChatModal: React.FC<PrivateChatModalProps> = ({ isOpen, onClose, onStartChat, conversations }) => {
  ...
  return (
    <div 
      className={`absolute inset-0 bg-black/60 z-[100] flex items-end justify-center transition-opacity duration-300 ${isOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
      onClick={onClose}
    >
      <div
